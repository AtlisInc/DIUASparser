...
/**
 * A {@link UASparser} which is only concerned with returning the browser family
 * string as quickly as possible. Uses the JRegex library for further speedups.
 *
 * You can optionally ignore unwanted browsers by passing in a list of browsers
...
public class BrowserFamilyParser extends UASparser {
     ...
     * @param browsers Only the browsers included in this list will be tested
     * for
     * @throws IOException
     */
